...
export default function AnimalCreateSuccess() {
  return (
    <main className="px-8 pt-10 flex justify-center items-center h-screen">
      <Card className="bg-white p-4">
        <CardTitle className="text-center">Ajout réussi!</CardTitle>
        <CardDescription className="text-center">
          Redirection suite l&apos;ajout d&apos;un animal
        </CardDescription>
        <CardContent className="text-xl font-bold my-6">
          <p className="text-center">L&apos;animal a été ajouté avec succès!</p>
        </CardContent>
